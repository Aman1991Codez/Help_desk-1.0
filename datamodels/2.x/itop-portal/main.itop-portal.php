...
DBObject::RegisterURLMakerClass('portal', 'JSOFT_SOLUTION_PortalEditUrlMaker');
DBObject::RegisterURLMakerClass('JSOFT_SOLUTION-portal', 'JSOFT_SOLUTION_PortalEditUrlMaker');
DBObject::RegisterURLMakerClass('JSOFT_SOLUTION-portal-edit', 'JSOFT_SOLUTION_PortalEditUrlMaker');
DBObject::RegisterURLMakerClass('JSOFT_SOLUTION-portal-view', 'JSOFT_SOLUTION_PortalViewUrlMaker');
