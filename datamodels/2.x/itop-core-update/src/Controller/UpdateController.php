...
class UpdateController extends Controller
{
	...
	public function OperationConfirmUpdate()
	{
		...
		{
			throw new Exception(Dict::S('JSOFT_SOLUTION_Update:Error:InvalidToken'));
		}
        ...
        try
        {
            if (isset($_FILES['file']))
            {
                ...
                if ($iError === UPLOAD_ERR_OK)
                {
                    ...
                    {
                        throw new Exception(Dict::S('JSOFT_SOLUTION_Update:Error:FileNotFound'));
                    }
                ...
                {
                    throw new Exception(Dict::S('JSOFT_SOLUTION_Update:Error:NoFile'));
                }
            }
            else
            {
        ...
        $sQuestion = Dict::Format('JSOFT_SOLUTION_Update:UI:ConfirmInstallFile', $sVersionToInstall);
