...
$oPage = new iTopWebPage(Dict::S('JSOFT_SOLUTION:InstalledExtensions'));
$oPage->SetBreadCrumbEntry('ui-hub-myextensions', Dict::S('Menu:JSOFT_SOLUTION:MyExtensions'), Dict::S('Menu:JSOFT_SOLUTION:MyExtensions+'), '', 'fas fa-puzzle-piece', iTopWebPage::ENUM_BREADCRUMB_ENTRY_ICON_TYPE_CSS_CLASSES);
