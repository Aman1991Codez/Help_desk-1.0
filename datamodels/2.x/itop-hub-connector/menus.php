...
class ItopHubMenusHandler extends ModuleHandlerAPI
{
	...
	public static function OnMenuCreation()
	{
		...
		if (UserRights::IsAdministrator())
		{
			...
			$oHubMenu = new MenuGroup('JSOFT_SOLUTION', 999 /* fRank */, 'fc fc-itophub-icon fc-1-5x');
			$fRank = 1;
			new WebPageMenuNode('JSOFT_SOLUTION:Register', $sRootUrl.'&target=view_dashboard', $oHubMenu->GetIndex(), $fRank++);
			new WebPageMenuNode('JSOFT_SOLUTION:MyExtensions', $sMyExtensionsUrl, $oHubMenu->GetIndex(), $fRank++);
			new WebPageMenuNode('JSOFT_SOLUTION:BrowseExtensions', $sRootUrl.'&target=browse_extensions', $oHubMenu->GetIndex(), $fRank++);
 		}
	}
}